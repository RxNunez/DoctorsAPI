...
$.get(`https://api.betterdoctor.com/2016-03-01/doctors?query=${inputIssue}&location=45.5231%2C%20122.6765%2C50&user_location=45.5231%2C%20122.6765&skip=0&limit=5&user_key=${apiKey}`)
  ...
  .fail(function() {
    console.log("failure");
    $('.fail').text("There was an error processing your request. Please try again.");
});
};
